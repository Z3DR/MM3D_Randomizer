...
void LocationTable_Init() {
 ...
 locationTable[POTION_SHOP_ITEM_1]                                 = ItemLocation::Shop       (0x0A,0x02, true,   "Potion Shop Item 1",                                       POTION_SHOP_ITEM_1,                             BLUE_POTION_REFILL,           {Category::cSouthernSwamp,Category::cShop,Category::cDayOne, Category::cNoOcarinaStart},                                                              SpoilerCollectionCheckGroup::GROUP_SOUTHERN_SWAMP);
 ...
 locationTable[POTION_SHOP_ITEM_3]                                 = ItemLocation::Shop       (0x0A,0x00, true,   "Potion Shop Item 3",                                       POTION_SHOP_ITEM_3,                             RED_POTION_REFILL,            {Category::cSouthernSwamp,Category::cShop,Category::cDayOne, Category::cNoOcarinaStart},                                                              SpoilerCollectionCheckGroup::GROUP_SOUTHERN_SWAMP);
