...
void LocationTable_Init() {
 ...
 locationTable[TRADING_POST_ITEM_2]                                = ItemLocation::Shop       (0x34,0x04, true,   "Trading Post Item 2",                                      TRADING_POST_ITEM_2,                            GREEN_POTION_REFILL,             {Category::cEastClockTown,Category::cShop,Category::cDayOne, Category::cNoOcarinaStart},                                                              SpoilerCollectionCheckGroup::GROUP_W_CLOCK_TOWN);
