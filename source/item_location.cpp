...
void LocationTable_Init() {
 ...
 locationTable[CLOCK_TOWER_OCARINA_OF_TIME]                        = ItemLocation::Collectable(0x19, 0x4C, false, "Ocarina of Time",                                          CLOCK_TOWER_OCARINA_OF_TIME,                    OCARINA_OF_TIME,              {Category::cClockTower, Category::cDayThree, Category::cNoOcarinaStart},                                                                                                                          SpoilerCollectionCheckGroup::GROUP_INSIDE_CLOCKTOWER );
