...
void LocationTable_Init() {
 ...
 locationTable[IKANA_CANYON_POE_HUT_HP]                            = ItemLocation::Base       (0x51, 0x06, false, "IC Poe Hut",                                               IKANA_CANYON_POE_HUT_HP,                        PIECE_OF_HEART,               {Category::cIkanaCanyon, Category::cVanillaHeartPiece,Category::cDayOne},                                                  SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_IKANA_CANYON );
 ...
 locationTable[IKANA_CANYON_PAMELAS_FATHER]                        = ItemLocation::Base       (0x55, 0x7A, false, "IC Pamela's Father",                                       IKANA_CANYON_PAMELAS_FATHER,                    GIBDOS_MASK,                  {Category::cIkanaCanyon, Category::cVanillaMask,Category::cDayOne},                                                        SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_IKANA_CANYON );
 ...
 locationTable[IKANA_GRAVEYARD_IRON_KNUCKLE_CHEST]                 = ItemLocation::Chest      (0x0C, 0x04, false, "IG Iron Knuckle Chest",                                    IKANA_GRAVEYARD_IRON_KNUCKLE_CHEST,             PIECE_OF_HEART,               {Category::cIkanaGraveyard, Category::cVanillaHeartPiece, Category::cChest, Category::cDayTwo},                                                                        SpoilerCollectionCheckGroup::GROUP_IKANA_GRAVEYARD );
 ...
 locationTable[MILK_ROAD_KEATON_QUIZ]                              = ItemLocation::Base       (0x22, 0x0C, false, "MR Keaton Quiz",                                           MILK_ROAD_KEATON_QUIZ,                          PIECE_OF_HEART,               {Category::cMilkRoad, Category::cDayOne},                                                                                  SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_MILK_ROAD );
 ...
 locationTable[N_CLOCK_TOWN_KEATON_QUIZ]                           = ItemLocation::Base       (0x6E, 0x0C, false, "NCT Keaton Quiz",                                          N_CLOCK_TOWN_KEATON_QUIZ,                       PIECE_OF_HEART,               {Category::cNorthClockTown, Category::cMinigame, Category::cVanillaHeartPiece,Category::cDayOne},                          SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_N_CLOCK_TOWN );
 ...
 //Stone Tower
 locationTable[STONE_TOWER_INVERTED_RIGHT_CHEST]                   = ItemLocation::Chest      (0x18, 0x1D, true,  "IST Right Chest",                                          STONE_TOWER_INVERTED_RIGHT_CHEST,               SILVER_RUPEE,                 {Category::cStoneTower,Category::cChest,Category::cDayOne},                                                                                                            SpoilerCollectionCheckGroup::GROUP_STONE_TOWER );
 locationTable[STONE_TOWER_INVERTED_CENTER_CHEST]                  = ItemLocation::Chest      (0x18, 0x1E, true,  "IST Center Chest",                                         STONE_TOWER_INVERTED_CENTER_CHEST,              BOMBCHU_10,                   {Category::cStoneTower,Category::cChest,Category::cDayOne},                                                                                                            SpoilerCollectionCheckGroup::GROUP_STONE_TOWER );
 locationTable[STONE_TOWER_INVERTED_LEFT_CHEST]                    = ItemLocation::Chest      (0x18, 0x1F, true,  "IST Left Chest",                                           STONE_TOWER_INVERTED_LEFT_CHEST,                MAGIC_BEAN,                   {Category::cStoneTower,Category::cChest,Category::cDayOne},                                                                                                            SpoilerCollectionCheckGroup::GROUP_STONE_TOWER );
