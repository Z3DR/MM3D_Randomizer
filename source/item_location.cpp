...
void LocationTable_Init() {
 ...
 //East Clock Town
 locationTable[E_CLOCK_TOWN_AROMA_IN_BAR]                          = ItemLocation::Base       (0x15, 0x6F, false, "ECT Milk Bar Madame Aroma",                                E_CLOCK_TOWN_AROMA_IN_BAR,                      CHATEAU_ROMANI,               {Category::cEastClockTown, Category::cDayThree, Category::cMainInventory, Category::cNoOcarinaStart},                                                 SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_E_CLOCK_TOWN );
 ...
 locationTable[E_CLOCK_TOWN_AROMA_IN_OFFICE]                       = ItemLocation::Base       (0x12, 0x8F, false, "ECT Mayor's Office Madame Aroma",                          E_CLOCK_TOWN_AROMA_IN_OFFICE,                   KAFEIS_MASK,                  {Category::cEastClockTown, Category::cDayOne, Category::cAnjuAndKafei, Category::cNoOcarinaStart},                                                    SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_E_CLOCK_TOWN );
 ...
 //Laundry Pool
 locationTable[LAUNDRY_POOL_KAFEI]                                 = ItemLocation::Base       (0x0D, 0xAB, true,  "LP Kafei's Pendant",                                       LAUNDRY_POOL_KAFEI,                             PENDANT_MEMORIES,             {Category::cLaundryPool,Category::cDayOne, Category::cAnjuAndKafei, Category::cNoOcarinaStart},                                                       SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_LAUNDRY_POOL );
 ...
 locationTable[LAUNDRY_POOL_CURIOSITY_SHOP_MAN_TWO]                = ItemLocation::Base       (0x0D, 0xA1, true,  "LP Curiosity Shop Man 2",                                  LAUNDRY_POOL_CURIOSITY_SHOP_MAN_TWO,            LETTER_MAMA,                  {Category::cLaundryPool,Category::cDayThree, Category::cAnjuAndKafei, Category::cNoOcarinaStart},                                                     SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_LAUNDRY_POOL );
 ...
 //Romani Ranch
 locationTable[ROMANI_RANCH_ALIEN_DEFENSE]                         = ItemLocation::Base       (0x35, 0x60, false,  "RR Alien Defense",                                         ROMANI_RANCH_ALIEN_DEFENSE,                     BOTTLE_WITH_MILK,             {Category::cRomaniRanch, Category::cNoOcarinaStart},                                                                                                 SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_ROMANI_RANCH );
 ...
 //Stock Pot Inn
 locationTable[STOCKPOTINN_RESERVATION]                            = ItemLocation::Base       (0x61, 0xA0, true,  "SPI Reservation",                                          STOCKPOTINN_RESERVATION,                        ROOM_KEY,                     {Category::cStockPotInn,Category::cDayOne, Category::cAnjuAndKafei, Category::cNoOcarinaStart},                                                       SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_STOCKPOTINN );
 locationTable[STOCKPOTINN_MIDNIGHT_MEETING]                       = ItemLocation::Base       (0x61, 0xAA, true,  "SPI Midnight Meeting",                                     STOCKPOTINN_MIDNIGHT_MEETING,                   LETTER_KAFEI,                 {Category::cStockPotInn,Category::cDayOne, Category::cAnjuAndKafei, Category::cNoOcarinaStart},                                                       SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_STOCKPOTINN );
 ...
 locationTable[STOCKPOTINN_STAFF_ROOM_CHEST]                       = ItemLocation::Chest      (0x61, 0x01, true,  "SPI Staff Room Chest",                                     STOCKPOTINN_STAFF_ROOM_CHEST,                   SILVER_RUPEE,                 {Category::cStockPotInn,Category::cChest ,Category::cDayThree, Category::cNoOcarinaStart},                                                                                                        SpoilerCollectionCheckGroup::GROUP_STOCKPOTINN );
