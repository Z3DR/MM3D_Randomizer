...
void LocationTable_Init() {
 ...
 locationTable[TRADING_POST_ITEM_1]                                = ItemLocation::Shop       (0x34,0x03, true,   "Trading Post Item 1",                                      TRADING_POST_ITEM_1,                            RED_POTION_REFILL,               {Category::cEastClockTown,Category::cShop,Category::cDayOne, Category::cNoOcarinaStart},                                                              SpoilerCollectionCheckGroup::GROUP_W_CLOCK_TOWN);
 locationTable[TRADING_POST_ITEM_2]                                = ItemLocation::Shop       (0x34,0xBA, true,   "Trading Post Item 2",                                      TRADING_POST_ITEM_2,                            GREEN_POTION_REFILL,             {Category::cEastClockTown,Category::cShop,Category::cDayOne, Category::cNoOcarinaStart},                                                              SpoilerCollectionCheckGroup::GROUP_W_CLOCK_TOWN);
 locationTable[TRADING_POST_ITEM_3]                                = ItemLocation::Shop       (0x34,0x05, true,   "Trading Post Item 3",                                      TRADING_POST_ITEM_3,                            HEROS_SHIELD,                    {Category::cEastClockTown,Category::cShop,Category::cDayOne, Category::cNoOcarinaStart},                                                              SpoilerCollectionCheckGroup::GROUP_W_CLOCK_TOWN);
 locationTable[TRADING_POST_ITEM_4]                                = ItemLocation::Shop       (0x34,0x06, true,   "Trading Post Item 4",                                      TRADING_POST_ITEM_4,                            BOTTLE_WITH_FAIRY,               {Category::cEastClockTown,Category::cShop,Category::cDayOne, Category::cNoOcarinaStart},                                                              SpoilerCollectionCheckGroup::GROUP_W_CLOCK_TOWN); 
 ...
 locationTable[TRADING_POST_ITEM_8]                                = ItemLocation::Shop       (0x34,0x0A, true,   "Trading Post Item 8",                                      TRADING_POST_ITEM_8,                            MAGIC_BEAN,                      {Category::cEastClockTown,Category::cShop,Category::cDayOne, Category::cNoOcarinaStart},                                                              SpoilerCollectionCheckGroup::GROUP_W_CLOCK_TOWN);
   
 locationTable[BOMB_SHOP_ITEM_1]                                   = ItemLocation::Shop       (0x68,0x17, true,   "Bomb Shop Item 1",                                         BOMB_SHOP_ITEM_1,                               BOMBS_10,                     {Category::cEastClockTown,Category::cShop,Category::cDayOne, Category::cNoOcarinaStart},                                                              SpoilerCollectionCheckGroup::GROUP_W_CLOCK_TOWN);
 ...
 locationTable[W_CLOCK_TOWN_BOMB_BAG_BUY]                          = ItemLocation::Shop       (0x68,0x1A, false,  "WCT Bomb Bag Purchase",                                    W_CLOCK_TOWN_BOMB_BAG_BUY,                      PROGRESSIVE_BOMB_BAG,         {Category::cWestClockTown,Category::cDayOne, Category::cShop, Category::cMainInventory, Category::cNoOcarinaStart},                                   SpoilerCollectionCheckGroup::GROUP_W_CLOCK_TOWN );
 locationTable[W_CLOCK_TOWN_BIG_BOMB_BAG_BUY]                      = ItemLocation::Shop       (0x68,0x04, false,  "WCT Big Bomb Bag Purchase",                                W_CLOCK_TOWN_BIG_BOMB_BAG_BUY,                  PROGRESSIVE_BOMB_BAG,         {Category::cWestClockTown,Category::cDayTwo, Category::cShop, Category::cMainInventory, Category::cNoOcarinaStart},                                   SpoilerCollectionCheckGroup::GROUP_W_CLOCK_TOWN );
