...
void LocationTable_Init() {
 ...
 locationTable[CLOCK_TOWER_SONG_OF_TIME]                           = ItemLocation::Base       (0x19, 0x53, false, "Song of Time",                                             CLOCK_TOWER_SONG_OF_TIME,                       SONG_OF_TIME,                 {Category::cClockTower, Category::cDayThree, Category::cSong, Category::cNoOcarinaStart},                                                             SpoilerCollectionCheck::ItemGetInf(6),      SpoilerCollectionCheckGroup::GROUP_INSIDE_CLOCKTOWER );
 ...
 locationTable[E_CLOCK_TOWN_POSTMAN_FREEDOM]                       = ItemLocation::Base       (0x6C, 0x84, false, "ECT Postman's Freedom",                                    E_CLOCK_TOWN_POSTMAN_FREEDOM,                   POSTMANS_HAT,                 {Category::cEastClockTown, Category::cVanillaMask,Category::cDayThree, Category::cNoOcarinaStart},                                                    SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_E_CLOCK_TOWN );
 locationTable[E_CLOCK_TOWN_GORMAN]                                = ItemLocation::Base       (0x15, 0x83, false, "ECT Milk Bar Gorman",                                      E_CLOCK_TOWN_GORMAN,                            CIRCUS_LEADERS_MASK,          {Category::cEastClockTown, Category::cVanillaMask,Category::cDayOne, Category::cNoOcarinaStart},                                                      SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_E_CLOCK_TOWN );
 ...
 locationTable[LAUNDRY_POOL_GURU_GURU]                             = ItemLocation::Base       (0x70, 0x8C, false, "LP Guru Guru",                                             LAUNDRY_POOL_GURU_GURU,                         BREMEN_MASK,                  {Category::cLaundryPool, Category::cVanillaMask,Category::cDayOne, Category::cNoOcarinaStart},                                                        SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_LAUNDRY_POOL );
 ...
 locationTable[S_CLOCK_TOWN_BANK_REWARD_2]                         = ItemLocation::Base       (0x6F, 0x03, false, "SCT Bank Reward 2",                                        S_CLOCK_TOWN_BANK_REWARD_2,                     BLUE_RUPEE,                   {Category::cSouthClockTown,Category::cDayOne},                                                                                                        SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_S_CLOCK_TOWN );
 ...
 locationTable[TWIN_ISLANDS_LULLABY_INTRO]                         = ItemLocation::Base       (0x5D, 0x74, false, "TI Lullaby Intro",                                         TWIN_ISLANDS_LULLABY_INTRO,                     LULLABY_INTRO,                {Category::cTwinIslands, Category::cSong, Category::cDayOne},                                                                                         SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_TWIN_ISLANDS );
 //W Clock Town
 ...
 locationTable[LAUNDRY_POOL_SF]                                    = ItemLocation::StrayFairy (0x70, 0x00, true,  "Laundry Pool SF",                                          CT_STRAY_FAIRY,                                 CT_STRAY_FAIRY,               {Category::cLaundryPool, Category::cVanillaStrayFairy, Category::cCTStray,Category::cDayOne, Category::cNoOcarinaStart},                                                                          SpoilerCollectionCheckGroup::GROUP_LAUNDRY_POOL);
