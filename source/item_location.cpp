...
void LocationTable_Init() {
 ...
 locationTable[GBC_FISHERMAN_PHOTO]                                = ItemLocation::Base       (0x3C, 0x95, false,  "GBC Fisherman Photo",                                      GBC_FISHERMAN_PHOTO,                            SEAHORSE,                     {Category::cGreatBayCoast},                                                                              SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_GREAT_BAY_COAST );
 ...
 locationTable[GORMAN_TRACK_MYSTERY_MILK_QUEST]                    = ItemLocation::Base       (0x6A, 0x70, false, "MR Gorman's Mystery Milk Quest",                           GORMAN_TRACK_MYSTERY_MILK_QUEST,                BOTTLE_WITH_MYSTERY_MILK,     {Category::cMilkRoad},                                                                                   SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_MILK_ROAD );
 locationTable[MILK_ROAD_KEATON_QUIZ]                              = ItemLocation::Base       (0x22, 0x03, false, "MR Keaton Quiz",                                           MILK_ROAD_KEATON_QUIZ,                          PIECE_OF_HEART,               {Category::cMilkRoad, Category::cDayOne},                                                                                  SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_MILK_ROAD );

 //Mountain Village
 locationTable[MOUNTAIN_VILLAGE_SMITH_DAY_ONE]                     = ItemLocation::Base       (0x2C, 0x38, false, "MV Razor Sword",                                           MOUNTAIN_VILLAGE_SMITH_DAY_ONE,                 RAZOR_SWORD,                  {Category::cMountainVillage,Category::cDayOne},                                                                            SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_MOUNTAIN_VILLAGE );
 locationTable[MOUNTAIN_VILLAGE_SMITH_DAY_TWO]                     = ItemLocation::Base       (0x2C, 0x39, false, "MV Gilded Sword",                                          MOUNTAIN_VILLAGE_SMITH_DAY_TWO,                 GILDED_SWORD,                 {Category::cMountainVillage,Category::cDayTwo},                                                                            SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_MOUNTAIN_VILLAGE );
 ...
 //Romani Ranch
 locationTable[ROMANI_RANCH_ALIEN_DEFENSE]                         = ItemLocation::Base       (0x35, 0x60, true,  "RR Alien Defense",                                         ROMANI_RANCH_ALIEN_DEFENSE,                     BOTTLE_WITH_MILK,             {Category::cRomaniRanch},                                                                                SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_ROMANI_RANCH );
 ...
 locationTable[SOUTHERN_SWAMP_KOTAKE]                              = ItemLocation::Base       (0x0A, 0x59, false,  "SS Kotake",                                                SOUTHERN_SWAMP_KOTAKE,                         BOTTLE_WITH_RED_POTION,       {Category::cSouthernSwamp},                                                                                                SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_SOUTHERN_SWAMP );
 ...
 locationTable[SWAMP_TOURIST_CENTER_ROOF_CLEAR]                    = ItemLocation::Collectable(0x00, 0x00, false, "SS Tourist Center Roof (Cleared)",                         SWAMP_TOURIST_CENTER_ROOF_CLEAR,                PIECE_OF_HEART,               {Category::cSouthernSwamp, Category::cVanillaHeartPiece,Category::cDayOne},                                                                                            SpoilerCollectionCheckGroup::GROUP_SOUTHERN_SWAMP );
 locationTable[SOUTHERN_SWAMP_SCRUB_TRADE_CLEAR]                   = ItemLocation::Base       (0x00, 0x98, true,  "SS Deku Scrub Merchant Trade (Cleared)",                   SOUTHERN_SWAMP_SCRUB_TRADE_CLEAR,               SWAMP_TITLE,                  {Category::cSouthernSwamp, Category::cDekuScrub,Category::cDayOne},                                                        SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_SOUTHERN_SWAMP );
 ...
 locationTable[TWIN_ISLANDS_GORON_RACE]                            = ItemLocation::Base       (0x6B, 0x6A, true,  "TI Goron Racetrack Race",                                  TWIN_ISLANDS_GORON_RACE,                        GOLD_DUST,                    {Category::cTwinIslands},                                                                                SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_TWIN_ISLANDS );
