...
void LocationTable_Init() {
 ...
 locationTable[THE_MOON_IRON_KNUCKLE_CHEST]                        = ItemLocation::Chest      (0x67, 0x02, true,  "The Moon Iron Knuckle Chest",                              THE_MOON_IRON_KNUCKLE_CHEST,                    BOMBCHU_10,                   {Category::cTheMoon,Category::cDayThree, Category::cMoonItems},                                                                                                        SpoilerCollectionCheckGroup::GROUP_DUNGEON_THE_MOON );
