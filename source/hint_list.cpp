...
//SONGS
    ...
    //        //obscure
    //        Text{"double time", "**FRENCH**", "**SPANISH**"});
    //hintTable[INVERTED_SONG_OF_TIME] = HintText::Item({
    //        //obscure
    //        Text{"slowed time", "**FRENCH**", "**SPANISH**"});
...
//SMALLKEYS
    ...
    //        //obscure
    //        Text{"a useful key", "**FRENCH**", "**SPANISH**"});
...
//N Clock Town
    ...
    //        //obscure
    //        Text{"a game for scrubs", "**FRENCH**", "**SPANISH**"});
//Road to Snowhead
...
//W Clock Town
    ...
    //        //obscure
    //        Text{"a town merchant", "**FRENCH**", "**SPANISH**"});
//Woodfall
...
//Oceanside spider House
    ...
    hintTable[ODOLWA] = HintText::Boss({
            //obscure
            Text{"a masked jungle warrior holds", "**FRENCH**", "**SPANISH**"});
    hintTable[GOHT] = HintText::Boss({
            //obscure
            Text{"a masked mechanical monster holds", "**FRENCH**", "**SPANISH**"});
    hintTable[GYORG] = HintText::Boss({
            //obscure
            Text{"a gargantuan masked fish holds", "**FRENCH**", "**SPANISH**"});
    hintTable[TWINMOLD] = HintText::Boss({
            //obscure
            Text{"a giant masked insect holds", "**FRENCH**", "**SPANISH**"});
    hintTable[MAJORA] = HintText::Boss({
            //obscure
            Text{"a cursed mask holds", "**FRENCH**", "**SPANISH**"});
