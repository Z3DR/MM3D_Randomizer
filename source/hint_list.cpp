...
void HintTable_Init() {
   /*--------------------------
    ...
    hintTable[HMS_DEKU_MASK] = HintText::Sometimes({ Text{"a cursed removed","a cursed removed","a cursed removed"}});
    hintTable[HMS_SONG_OF_HEALING] = HintText::Sometimes({ Text{"a masked man's melody","a masked man's melody","a masked man's melody"}});
    hintTable[HMS_BOMBERS_NOTEBOOK] = HintText::Sometimes({ Text{"a masked man's gift","a masked man's gift","a masked man's gift"}});
    hintTable[HMS_STARTING_SWORD] = HintText::Sometimes({ Text{"a new file","a new file","a new file"}});
    hintTable[HMS_STARTING_SHIELD] = HintText::Sometimes({ Text{"a new file","a new file","a new file"}});
...
//Goron Village
    ...
    hintTable[GORON_SHOP_ITEM_1] = HintText::Sometimes({ Text{"a goron shop", "", ""}});
    hintTable[GORON_SHOP_ITEM_2] = HintText::Sometimes({ Text{"a goron shop", "", ""}});
    hintTable[GORON_SHOP_ITEM_3] = HintText::Sometimes({ Text{"a goron shop", "", ""}});
//Great Bay Coast
...
//Milk Road
    hintTable[MILK_ROAD_GORMAN_RACE] = HintText::Sometimes({Text{"a sporting event", "", ""}});
    hintTable[MILK_ROAD_GORMAN_MILK_BUY] = HintText::Sometimes({Text{"a dodgy seller", "", ""}});
    hintTable[MILK_ROAD_KEATON_QUIZ] = HintText::Sometimes({Text{"a mysterious fox", "", ""}});
    hintTable[TINGLE_MILK_ROAD_RR] = HintText::Sometimes({Text{"a map maker", "", ""}});
    hintTable[TINGLE_MILK_ROAD_GB] = HintText::Sometimes({Text{"a map maker", "", ""}});
//Mountain Village
    hintTable[MOUNTAIN_VILLAGE_SMITH_DAY_ONE] = HintText::Sometimes({Text{"a moutain smith", "", ""}});
    hintTable[MOUNTAIN_VILLAGE_SMITH_DAY_TWO] = HintText::Sometimes({Text{"a mountain smith", "", ""}});
    hintTable[MOUNTAIN_VILLAGE_FROG_CHOIR] = HintText::Sometimes({Text{"a frog choir", "", ""}});
    hintTable[MOUNTAIN_VILLAGE_DARMANI] = HintText::Sometimes({Text{"a mountain spirit", "", ""}});
    hintTable[MOUNTAIN_VILLAGE_HUNGRY_GORON] = HintText::Sometimes({Text{"a hungry goron", "", ""}});
    hintTable[MOUNTAIN_WATERFALL_CHEST] = HintText::Sometimes({Text{"a springtime waterfall", "", ""}});
    hintTable[MOUNTAIN_VILLAGE_SPRING_WATER_GROTTO_CHEST] = HintText::Sometimes({Text{"a springtime cave", "", ""}});
//N Clock Town
  ...
  //hintTable[N_CLOCK_TOWN_BOMBERS_HIDE_SEEK] = HintText::Sometimes({Text{"", "", ""}}); doesn't give an item in 3d
    hintTable[N_CLOCK_TOWN_KEATON_QUIZ] = HintText::Sometimes({Text{"a mysterious fox", "", ""}});
    hintTable[N_CLOCK_TOWN_DEKU_PLAYGROUND_3DAYS] = HintText::Sometimes({Text{"a game for scrubs", "", ""}});
    hintTable[N_CLOCK_TOWN_TREE] = HintText::Sometimes({Text{"a town playground", "", ""}});
    hintTable[N_CLOCK_TOWN_OLD_LADY] = HintText::Sometimes({Text{"an old lady's struggle", "", ""}});
    hintTable[N_CLOCK_TOWN_GREAT_FAIRY_HUMAN] = HintText::Sometimes({Text{"the fairy of magic", "", ""}});
    hintTable[TINGLE_N_CLOCK_TOWN_CT] = HintText::Sometimes({Text{"a map maker", "", ""}});
    hintTable[TINGLE_N_CLOCK_TOWN_WF] = HintText::Sometimes({Text{"a map maker", "", ""}});
    hintTable[N_CLOCK_TOWN_POSTBOX] = HintText::Sometimes({Text{"a correspondence box", "", ""}});
  //hintTable[N_CLOCK_TOWN_DEKU_PLAYGROUND_ADAY] = HintText::Sometimes({Text{"a game for scrubs", "", ""}});
//Road to Snowhead
    hintTable[ROAD_TO_SNOWHEAD_PILLAR] = HintText::Sometimes({Text{"a cold platform", "", ""}});
    hintTable[ROAD_TO_SNOWHEAD_GROTTO_CHEST] = HintText::Sometimes({Text{"a snowy cave", "", ""}});
//Pinnacle Rock
    hintTable[PINNACLE_ROCK_SEAHORSES] = HintText::Sometimes({Text{"a fishy reunion", "", ""}});
    hintTable[PINNACLE_ROCK_UPPER_CHEST] = HintText::Sometimes({Text{"a marine trench", "", ""}});
    hintTable[PINNACLE_ROCK_LOWER_CHEST] = HintText::Sometimes({Text{"a marine trench", "", ""}});
    hintTable[PINNACLE_ROCK_ZORA_EGG1] = HintText::Sometimes({Text{"a marine trench", "", ""}});
    hintTable[PINNACLE_ROCK_ZORA_EGG2] = HintText::Sometimes({Text{"a marine trench", "", ""}});
    hintTable[PINNACLE_ROCK_ZORA_EGG3] = HintText::Sometimes({Text{"a marine trench", "", ""}});
//Road to Ikana
    hintTable[ROAD_TO_IKANA_PILLAR_CHEST] = HintText::Sometimes({Text{"a high chest", "", ""}});
    hintTable[ROAD_TO_IKANA_GROTTO_CHEST] = HintText::Sometimes({Text{"a blocked cave", "", ""}});
//Road to Southern Swamp
    hintTable[ROAD_TO_SS_ARCHERY_1] = HintText::Sometimes({Text{"a swamp game", "", ""}});
    hintTable[ROAD_TO_SS_ARCHERY_2] = HintText::Sometimes({Text{"a swamp game", "", ""}});
    hintTable[ROAD_TO_SS_TREE] = HintText::Sometimes({Text{"a batty tree", "", ""}});
    hintTable[ROAD_TO_SWAMP_GROTTO_CHEST] = HintText::Sometimes({Text{"a southern cave", "", ""}});
    hintTable[TINGLE_ROAD_TO_SS_WF] = HintText::Sometimes({Text{"a map maker", "", ""}});
    hintTable[TINGLE_ROAD_TO_SS_SH] = HintText::Sometimes({Text{"a map maker", "", ""}});
//Romani Ranch
    hintTable[ROMANI_RANCH_ALIEN_DEFENSE] = HintText::Sometimes({Text{"a ranch invasion", "", ""}});
    hintTable[ROMANI_RANCH_DOG_RACE] = HintText::Sometimes({Text{"a sporting event", "", ""}});
    hintTable[ROMANI_RANCH_GROG] = HintText::Sometimes({Text{"a chicken lover", "", ""}});
    hintTable[ROMANI_RANCH_CREMIA_ESCORT] = HintText::Sometimes({Text{"an older sister", "", ""}});
    hintTable[ROMANI_RANCH_ROMANIS_GAME] = HintText::Sometimes({Text{"an equine reunion", "", ""}});
    hintTable[ROMANI_RANCH_COW_1] = HintText::Sometimes({Text{"a lost creature", "", ""}});
    hintTable[ROMANI_RANCH_COW_2] = HintText::Sometimes({Text{"a lost creature", "", ""}});
    hintTable[ROMANI_RANCH_COW_3] = HintText::Sometimes({Text{"a lost creature", "", ""}});
    hintTable[DOGGY_RACETRACK_ROOF_CHEST] = HintText::Sometimes({Text{"a day at the races", "", ""}});
//S Clock Town
    hintTable[S_CLOCK_TOWN_SCRUB_TRADE] = HintText::Sometimes({Text{"a town merchant", "", ""}});
    hintTable[S_CLOCK_TOWN_POSTBOX] = HintText::Sometimes({Text{"a correspondence box", "", ""}});
    hintTable[S_CLOCK_TOWN_CLOCK_TOWER_ENTRANCE] = HintText::Sometimes({Text{"the tower doors", "", ""}});
    hintTable[S_CLOCK_TOWN_STRAW_ROOF_CHEST] = HintText::Sometimes({Text{"a straw roof", "", ""}});
    hintTable[S_CLOCK_TOWN_FINAL_DAY_CHEST] = HintText::Sometimes({Text{"a carnival tower", "", ""}});
    hintTable[S_CLOCK_TOWN_BANK_REWARD_1] = HintText::Sometimes({Text{"a keeper of wealth", "", ""}});
    hintTable[S_CLOCK_TOWN_BANK_REWARD_2] = HintText::Sometimes({Text{"interest", "", ""}});
    hintTable[S_CLOCK_TOWN_BANK_REWARD_3] = HintText::Sometimes({Text{"being rich", "", ""}});
//Snowhead
    hintTable[SNOWHEAD_GREAT_FAIRY] = HintText::Sometimes({Text{"the fairy of power", "", ""}});
//Southern Swamp
    hintTable[SOUTHERN_SWAMP_KOUME] = HintText::Sometimes({Text{"a witch", "", ""}});
    hintTable[SOUTHERN_SWAMP_KOTAKE] = HintText::Sometimes({Text{"a sleeping witch", "", ""}});
    hintTable[SOUTHERN_SWAMP_KOTAKE_IN_WOODS] = HintText::Sometimes({Text{"a witch", "", ""}});
    hintTable[SOUTHERN_SWAMP_SCRUB_TRADE] = HintText::Sometimes({Text{"a southern merchant", "", ""}});
    hintTable[SOUTHERN_SWAMP_PICTOGRAPH_WINNER] = HintText::Sometimes({Text{"a swamp game", "", ""}});
    hintTable[SOUTHERN_SWAMP_BOAT_ARCHERY] = HintText::Sometimes({Text{"a swamp game", "", ""}});
    hintTable[SWAMP_TOURIST_CENTER_ROOF] = HintText::Sometimes({Text{"a tourist center", "", ""}});
    hintTable[SOUTHERN_SWAMP_NEAR_SPIDER_HOUSE_GROTTO_CHEST] = HintText::Sometimes({Text{"a swampy cave", "", ""}});
    hintTable[SOUTHERN_SWAMP_SPIDER_HOUSE_REWARD] = HintText::Sometimes({Text{"a swamp spider reward", "", ""}});
    hintTable[SOUTHERN_SWAMP_MYSTERY_WOODS_GROTTO_CHEST] = HintText::Sometimes({Text{"a mystery cave", "", ""}});
    hintTable[SOUTHERN_SWAMP_KOTAKE_MUSHROOM_SALE] = HintText::Sometimes({Text{"a sleeping witch", "", ""}});
  ...
  //hintTable[SOUTHERN_SWAMP_PICTOGRAPH_GOOD] = HintText::Sometimes({Text{"", "", ""}});
    hintTable[SOUTHERN_SWAMP_SCRUB_PURCHASE] = HintText::Sometimes({Text{"a southern merchant", "", ""}});
    hintTable[POTION_SHOP_ITEM_1] = HintText::Sometimes({Text{"a potion maker", "", ""}});
    hintTable[POTION_SHOP_ITEM_2] = HintText::Sometimes({Text{"a potion maker", "", ""}});
    hintTable[POTION_SHOP_ITEM_3] = HintText::Sometimes({Text{"a potion maker", "", ""}});
//StockPotInn
    hintTable[STOCKPOTINN_RESERVATION] = HintText::Sometimes({Text{"check-in", "", ""}});
    hintTable[STOCKPOTINN_MIDNIGHT_MEETING] = HintText::Sometimes({Text{"a late meeting", "", ""}});
    hintTable[STOCKPOTINN_TOILET_HAND] = HintText::Sometimes({Text{"a strange palm", "", ""}});
    hintTable[STOCKPOTINN_GRANDMA_SHORT_STORY] = HintText::Sometimes({Text{"an old lady", "", ""}});
    hintTable[STOCKPOTINN_GRANDMA_LONG_STORY] = HintText::Sometimes({Text{"an old lady", "", ""}});
    hintTable[STOCKPOTINN_ANJU_AND_KAFEI] = HintText::Sometimes({Text{"a lovers' reunion", "", ""}});
    hintTable[STOCKPOTINN_STAFF_ROOM_CHEST] = HintText::Sometimes({Text{"an employee room", "", ""}});
    hintTable[STOCKPOTINN_GUEST_ROOM_CHEST] = HintText::Sometimes({Text{"a guest bedroom", "", ""}});
//Stone Tower
    hintTable[STONE_TOWER_INVERTED_RIGHT_CHEST] = HintText::Sometimes({Text{"a sky below", "", ""}});
    hintTable[STONE_TOWER_INVERTED_CENTER_CHEST] = HintText::Sometimes({Text{"a sky below", "", ""}});
    hintTable[STONE_TOWER_INVERTED_LEFT_CHEST] = HintText::Sometimes({Text{"a sky below", "", ""}});
//Termina Field
    hintTable[TERMINA_FIELD_MOONS_TEAR] = HintText::Sometimes({Text{"a falling star", "", ""}});
    hintTable[TERMINA_FIELD_GOSSIP_STONES] = HintText::Sometimes({Text{"mysterious stones", "", ""}});
    hintTable[TERMINA_FIELD_BUSINESS_SCRUB] = HintText::Sometimes({Text{"a hidden merchant", "", ""}});
    hintTable[TERMINA_FIELD_PEAHAT_GROTTO_CHEST] = HintText::Sometimes({Text{"a hollow ground", "", ""}});
    hintTable[TERMINA_FIELD_DODONGO_GROTTO_CHEST] = HintText::Sometimes({Text{"a hollow ground", "", ""}});
    hintTable[TERMINA_FIELD_BIO_BABA_GROTTO_BEEHIVE] = HintText::Sometimes({Text{"a beehive", "", ""}});
    hintTable[TERMINA_FIELD_KAMARO] = HintText::Sometimes({Text{"a dancer", "", ""}});
    hintTable[TERMINA_FIELD_PILLAR_GROTTO_CHEST] = HintText::Sometimes({Text{"a hollow pillar", "", ""}});
    hintTable[TERMINA_FIELD_GRASS_GROTTO_CHEST] = HintText::Sometimes({Text{"a grassy cave", "", ""}});
    hintTable[TERMINA_FIELD_UNDERWATER_CHEST] = HintText::Sometimes({Text{"a sunken chest", "", ""}});
    hintTable[TERMINA_FIELD_GRASS_CHEST] = HintText::Sometimes({Text{"a grassy chest", "", ""}});
    hintTable[TERMINA_FIELD_STUMP_CHEST] = HintText::Sometimes({Text{"a tree chest", "", ""}});
    hintTable[TERMINA_FIELD_GROTTO_COW1] = HintText::Sometimes({Text{"a lost creature", "", ""}});
    hintTable[TERMINA_FIELD_GROTTO_COW2] = HintText::Sometimes({Text{"a lost creature", "", ""}});
//Twin Islands
    hintTable[HOT_SPRING_WATER_GROTTO_CHEST] = HintText::Sometimes({Text{"a steamy grotto", "", ""}});
    hintTable[TWIN_ISLANDS_GORON_RACE] = HintText::Sometimes({Text{"a sporting event", "", ""}});
    hintTable[TWIN_ISLANDS_GORON_RACETRACK_GROTTO_CHEST] = HintText::Sometimes({Text{"a hidden cave", "", ""}});
    hintTable[TWIN_ISLANDS_UNDERWATER_RAMP_CHEST] = HintText::Sometimes({Text{"a spring treasure", "", ""}});
    hintTable[TWIN_ISLANDS_CAVE_CHEST] = HintText::Sometimes({Text{"a sunken springtime treasure", "", ""}});
    hintTable[TINGLE_TWIN_ISLANDS_SH] = HintText::Sometimes({Text{"a map maker", "", ""}});
    hintTable[TINGLE_TWIN_ISLANDS_RR] = HintText::Sometimes({Text{"a map maker", "", ""}});
    hintTable[TINGLE_TWIN_ISLANDS_SH_SPRING] = HintText::Sometimes({Text{"a map maker", "", ""}});
    hintTable[TINGLE_TWIN_ISLANDS_RR_SPRING] = HintText::Sometimes({Text{"a map maker", "", ""}});
//W Clock Town
    hintTable[W_CLOCK_TOWN_BOMB_BAG_BUY] = HintText::Sometimes({Text{"a town merchant", "", ""}});
    hintTable[W_CLOCK_TOWN_BIG_BOMB_BAG_BUY] = HintText::Sometimes({Text{"a town merchant", "", ""}});
    hintTable[W_CLOCK_TOWN_POSTMANS_GAME] = HintText::Sometimes({Text{"a delivery person", "", ""}});
    hintTable[W_CLOCK_TOWN_ROSA_SISTERS] = HintText::Sometimes({Text{"traveling sisters", "", ""}});
    hintTable[W_CLOCK_TOWN_SWORDSMANS_SCHOOL] = HintText::Sometimes({Text{"a town game", "", ""}});
    hintTable[W_CLOCK_TOWN_ALL_NIGHT_MASK_BUY] = HintText::Sometimes({Text{"a shady town merchant", "", ""}});
    hintTable[W_CLOCK_TOWN_BOMB_SHOP_GORON] = HintText::Sometimes({Text{"a town goron merchant", "", ""}});
    hintTable[W_CLOCK_TOWN_POSTBOX] = HintText::Sometimes({Text{"a correspondence box", "", ""}});
  //hintTable[W_CLOCK_TOWN_LOTTERY] = HintText::Sometimes({Text{"", "", ""}});
    hintTable[TRADING_POST_ITEM_1] = HintText::Sometimes({Text{"a town merchant", "", ""}});
    hintTable[TRADING_POST_ITEM_2] = HintText::Sometimes({Text{"a town merchant", "", ""}});
    hintTable[TRADING_POST_ITEM_3] = HintText::Sometimes({Text{"a town merchant", "", ""}});
    hintTable[TRADING_POST_ITEM_4] = HintText::Sometimes({Text{"a town merchant", "", ""}});
    hintTable[TRADING_POST_ITEM_5] = HintText::Sometimes({Text{"a town merchant", "", ""}});
    hintTable[TRADING_POST_ITEM_6] = HintText::Sometimes({Text{"a town merchant", "", ""}});
    hintTable[TRADING_POST_ITEM_7] = HintText::Sometimes({Text{"a town merchant", "", ""}});
    hintTable[TRADING_POST_ITEM_8] = HintText::Sometimes({Text{"a town merchant", "", ""}});
    hintTable[BOMB_SHOP_ITEM_1] = HintText::Sometimes({Text{"a town merchant", "", ""}});
    hintTable[BOMB_SHOP_ITEM_2] = HintText::Sometimes({Text{"a town merchant", "", ""}});
  //hintTable[BOMB_SHOP_ITEM_3] = HintText::Sometimes({Text{"a town merchant", "", ""}});
//Woodfall
    hintTable[WOODFALL_BRIDGE_CHEST] = HintText::Sometimes({Text{"a swamp chest", "", ""}});
    hintTable[WOODFALL_BEHIND_OWL_CHEST] = HintText::Sometimes({Text{"a swamp chest", "", ""}});
    hintTable[ENTRANCE_TO_WOODFALL_CHEST] = HintText::Sometimes({Text{"a swamp chest", "", ""}});
...
//Zora Cape
    ...
    hintTable[ZORA_CAPE_BEAVER_RACE_1] = HintText::Sometimes({Text{"a river dweller", "", ""}});
    hintTable[ZORA_CAPE_BEAVER_RACE_2] = HintText::Sometimes({Text{"a river dweller", "", ""}});
    hintTable[ZORA_CAPE_LIKE_LIKE] = HintText::Sometimes({Text{"a shield eater", "", ""}});
    hintTable[ZORA_CAPE_LEDGE_NO_TREE] = HintText::Sometimes({Text{"a high place", "", ""}});
    hintTable[ZORA_CAPE_LEDGE_WITH_TREE] = HintText::Sometimes({Text{"a high place", "", ""}});
    hintTable[ZORA_CAPE_GROTTO_CHEST] = HintText::Sometimes({Text{"a beach cave", "", ""}});
    hintTable[ZORA_CAPE_UNDERWATER_CHEST] = HintText::Sometimes({Text{"a sunken chest", "", ""}});
//Zora Hall
    hintTable[ZORA_HALL_SCRUB_TRADE] = HintText::Sometimes({Text{"a western merchant", "", ""}});
    hintTable[ZORA_HALL_EVAN] = HintText::Sometimes({Text{"a musician", "", ""}});
    hintTable[ZORA_HALL_LULU_ROOM_LEDGE] = HintText::Sometimes({Text{"the singer's room", "", ""}});
    hintTable[ZORA_HALL_SCRUB_PURCHASE] = HintText::Sometimes({Text{"a western merchant", "", ""}});
  ...
  //hintTable[ZORA_HALL_GOOD_PHOTO_LULU] = HintText::Sometimes({Text{"a fan", "", ""}});
    hintTable[ZORA_SHOP_ITEM_1] = HintText::Sometimes({Text{"a zora merchant", "", ""}});
    hintTable[ZORA_SHOP_ITEM_2] = HintText::Sometimes({Text{"a zora merchant", "", ""}});
    hintTable[ZORA_SHOP_ITEM_3] = HintText::Sometimes({Text{"a zora merchant", "", ""}});
