...
//Zora Hall
  ...
  //ZORA_HALL_STAGE_LIGHTS = HintText::Sometimes({Text{""}});
  //ZORA_HALL_BAD_PHOTO_LULU = HintText::Sometimes({Text{""}});
  //ZORA_HALL_GOOD_PHOTO_LULU = HintText::Sometimes({Text{""}});
  ...
  |   JUNK HINT TEXT    |
  ---------------------*/
    hintTablehintTable[JUNK01] = HintText::Junk({Text{"junk hint here"}});
