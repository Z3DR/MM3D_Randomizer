...
Turning Custom Music off and generating again removes the songs the randomizer placed. Files you put in the game's `romfs/sound/streaming/stream/` folder yourself are never touched.
